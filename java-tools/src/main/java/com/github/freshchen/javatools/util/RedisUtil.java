...
public class RedisUtil {
     ...
     *
     * @param key
     * @return StrConstants.SUCCESS.getValue() or false
     */
...
// ================================Map=================================
     ...
     * @return StrConstants.SUCCESS.getValue() 成功 false失败
     */
    public String hset(String key, String item, Object value) {
        try {
     ...
     * @return StrConstants.SUCCESS.getValue() 成功 false失败
     */
    public String hset(String key, String item, Object value, long time) {
        try {
            redisTemplate.opsForHash().put(key, item, value);
            if (time > 0) {
                expire(key, time);
     ...
     * @param key  键 不能为null
     * @param item 项 不能为null
     * @return StrConstants.SUCCESS.getValue() 存在 false不存在
     */
...
// ===============================list=================================
     ...
     * @return
     */
    public String lSet(String key, Object value) {
        try {
     ...
     * @return
     */
    public String lSet(String key, Object value, long time) {
        try {
            redisTemplate.opsForList().rightPush(key, value);
            if (time > 0)
                expire(key, time);
     ...
     * @return
     */
    public String lUpdateIndex(String key, long index, Object value) {
        try {
